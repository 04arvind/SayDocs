...
const Footer = () => {
  return (
    <footer className="mt-4 lg:mt-0 bg-gradient-to-r from-gray-900 to-black border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-12">
        ...
        <div className="border-t border-white/10 mt-4 lg:mt-8 pt-4 lg:pt-8 text-center">
